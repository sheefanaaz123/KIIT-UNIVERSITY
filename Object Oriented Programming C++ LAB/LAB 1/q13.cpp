...
int main() {
  ...
  cout << "Enter the element of 1D array ::";   
  ...
  for(i_8085 = 1;i_8085 < N_8085; i_8085++) {
    if(arr_8085[0] < arr_8085[i_8085])                   //if the element is greater than element in 0 th index,
      arr_8085[0] = arr_8085[i_8085];                     // then make that element the 0th element.
	    }

  cout <<"Largest element in 1D array is"<<" " << arr_8085[0];       
